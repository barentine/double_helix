...
class DetectionParamsDialog(wx.Dialog):
    def __init__(self, parent, defaultVal=[-1e3, -1e3, -1e3]):
        ...
        self.roi_half_size = wx.TextCtrl(self, -1, '%1.6G' % defaultVal[0], size=(80, -1))
        ...
        self.lobe_sep_guess = wx.TextCtrl(self, -1, '%1.6G' % defaultVal[1], size=(80, -1))
        ...
        self.lobe_sigma_guess = wx.TextCtrl(self, -1, '%1.6G' % defaultVal[2], size=(80, -1))
